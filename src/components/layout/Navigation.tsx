...
export function Navigation({ items }: NavigationProps) {
  ...
  return (
    <>
      ...
      >
        <div
          className="h-full bg-surveillance-green/50"
          style={{
            width: `${progress * 100}%`,
              ...
              return (
                <button
                  ...
                  className={`group flex w-full items-start gap-4 border-l-2 px-5 py-3.5 text-left transition-all duration-300 ${
                    isActive
                      ? 'border-surveillance-green bg-surveillance-green/10'
                ...
                >
                  ...
                  {/* Active dot */}
                  {isActive && (
                    <span className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-surveillance-green shadow-[0_0_6px_rgba(74,103,65,0.5)]" />
                  )}
                </button>
              )
            })}
      ...
      >
        {items.map((item) => (
          ...
          >
            <span
              className={`block h-1.5 w-1.5 rounded-full transition-all duration-300 group-hover:scale-150 group-hover:bg-surveillance-green group-hover:shadow-[0_0_8px_rgba(74,103,65,0.4)] ${
                activeId === item.id
                  ? 'scale-150 bg-surveillance-green shadow-[0_0_8px_rgba(74,103,65,0.4)]'
                  : 'bg-stone'
              }`}
            />
